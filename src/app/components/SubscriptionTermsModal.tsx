    ...
    >
      <div className="p-6 flex flex-col h-[80vh]">
        ...
        <div className="flex-1 overflow-y-auto pr-4 text-sm text-gray-700">
          ...
          <p className="mb-4">
            We collect this data through our servers and the use of cookies and other technologies. Cookies are small text files that can be read by a web server in the domain that put the cookie on your hard drive. Cookies are widely used in order to make websites and other applications work, or work more efficiently, and help them remember certain information and recognize your internet browser. Cookies may last until you close your browser (“session” cookies) or over repeat visits (“persistent” cookies). We may use cookies and other technologies to store your preferences and settings, help you with signing in, provide targeted ads, and analyze site operations. You can control cookies through your browser’s settings and other tools. However, if you block certain cookies, you may not be able to register, login, or access certain parts or make full use of the Product.
          </p>
